...
class FriendsTest < ApplicationSystemTestCase
  ...
  test "should create friend" do
    ...
    fill_in "Brand", with: @friend.brand
    fill_in "Code", with: @friend.code
    fill_in "Colour", with: @friend.colour
    fill_in "Price", with: @friend.price
    fill_in "Quantity", with: @friend.quantity
    fill_in "Size", with: @friend.size
